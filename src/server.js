...
// Set AZURE_STORAGE_ACCOUNT and AZURE_STORAGE_ACCESS_KEY
// azure environment values as optional for running locally.
if (process.env.AZURE_STORAGE_ACCOUNT == undefined) {
	process.env.AZURE_STORAGE_ACCOUNT = "dummy";
}
if (process.env.AZURE_STORAGE_ACCESS_KEY == undefined) {
...
// tinyChat App //
//////////////////////////
var tinyChat = require('./controllers/tinyChat.js');
tinyChat.appendTinyChat(app);